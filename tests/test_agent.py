...
class AgentLoopTest(unittest.TestCase):
    ...
    def test_happy_path_write_read_finish(self):
        actions = [
        ...
        self.assertIn("wrote the file", result.steps[0].observation)
        self.assertIn("hello hello hello", result.steps[1].observation)
    ...
    def test_invalid_json_is_reported_and_loop_continues(self):
        ...
        self.assertIn("invalid", result.steps[0].observation)
        self.assertTrue(result.finished)
    ...
    def test_unknown_tool_is_reported(self):
        ...
        result = self._agent(actions, max_steps=5).run("t")
        self.assertFalse(result.steps[0].ok)
        self.assertIn("not a real tool", result.steps[0].observation)
